...
fn fs_main(in: VertexOutput) -> @location(0) f32 {
    var view_space_pos = view_proj_uniforms.view * textureSample(g_position, g_position_sampler, in.tex_coords.xy);
    var view_space_normal = textureSample(g_normal, g_normal_sampler, in.tex_coords.xy).xyz;
    ...
    for (var i = 0; i < 64; i += 1) {
        ...
        offset.y = 1.0 - (offset.y * 0.5 + 0.5);
        var sample_depth = (view_proj_uniforms.view * textureSample(g_position, g_position_sampler, offset.xy)).z;
