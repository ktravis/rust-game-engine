...
impl SSAOPass {
    ...
    pub fn new(
        ...
        display: &Display,
        depth_buffer_bgl: &wgpu::BindGroupLayout,
        camera: &Camera,
    ) -> Self {
        ...
        let (kernel, uniform_bgl) = state.create_uniform_bind_group(
            display.device(),
            SSAOKernel::new(fb_size.as_vec2() / Self::NOISE_SCALE as f32, camera),
        );
        ...
        let pipeline = state
            ...
            .with_extra_bind_group_layouts(vec![depth_buffer_bgl, &uniform_bgl, &noise_texture_bgl])
            ...
            .build(
                ...
                &display
                    .device()
                    .create_shader_module(include_wgsl!("../../res/shaders/ssao_from_depth.wgsl")),
            );
    ...
    pub fn run(
        ...
        depth_buffer_bg: &wgpu::BindGroup,
    ) -> TextureRef {
        ...
        state
            .render_pass(
                ...
                view_projection,
                |r| {
                    r.set_bind_group(3, depth_buffer_bg, &[]);
